...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { amountPeople: @produto.amountPeople, description: @produto.description, images: @produto.images, name: @produto.name, price: @produto.price } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { amountPeople: @produto.amountPeople, description: @produto.description, images: @produto.images, name: @produto.name, price: @produto.price } }
